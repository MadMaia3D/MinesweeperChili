...
public:
	...
	static constexpr int faceSize = 39;
	...
	static void DrawFaceUnpressed(const Vei2& pos, Graphics& gfx);
	static void DrawFaceWin(const Vei2& pos, Graphics& gfx);
	static void DrawFaceLose(const Vei2& pos, Graphics& gfx);
